 ...
 * @LastEditTime: 2024-06-05 14:39:09
-->
<template>
  <div class="table-box">
...
const { fetchData } = useTableFetch(service.getStarRecordByPage, params => {
...
const onExport = () => {
  useDownload(service.memberStarRecordExport, `升星奖励`, filterParams.value);
};
</script>
