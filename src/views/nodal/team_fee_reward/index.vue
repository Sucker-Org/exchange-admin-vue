 ...
 * @LastEditTime: 2024-06-05 14:39:16
-->
<template>
  <div class="table-box">
...
const { fetchData } = useTableFetch(service.getTeamFeeRewardByPage, params => {
...
const onExport = () => {
  useDownload(service.groupChargeAwardExport, `团队手续费奖励`, filterParams.value);
};
</script>
