...
- GitLab：http://139.196.44.174/huidu_web/exchange-admin-vue
...
```text
git clone http://139.196.44.174/huidu_web/exchange-admin-vue
```
...
- https://admin.api.huidu.xyz (账号：admin 密码：Aa123456)
